...
function preload(){
  ...
  ice=loadImage("icecream.jpeg");
  bgImg=loadImage("pro38bg.jpeg");
...
var icecream= createSprite(displayWidth,displayHeight,5,5);
dorame.y= Math.round(random(100,displayHeight-250));
icecream.y= Math.round(random(100,displayHeight-250));
dorame.addImage(doraImage);
icecream.addImage(ice);
dorame.lifetime=210;
icecream.lifetime=210;
dorame.velocityX=-6;
icecream.velocityX=-6;
dorame.scale=0.2;
icecream.scale=0.08;
    
doraGroup.add(dorame); 
doraGroup.add(icecream);
...
function Obstacle(){
  ...
  if(frameCount % 70 ===0){
var obstacle1 =createSprite(displayWidth-50,displayHeight-200,5,5); 
obstacle1.y=Math.round(random(200, displayHeight-200)); 
